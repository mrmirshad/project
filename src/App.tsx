...
const projectData: Project[] = [
  ...
  description:
    "දස දහසක් දරුවන්ගේ අධ්‍යාපනය වෙනුවෙන් උමංදාව!\n\nඇතිවුණු බිහිසුණු ගංවතුර ආපදා තත්ත්වය හේතුවෙන් පොත්පත් හා පාසල් උපකරණ අහිමිවීම නිසා දිවයින පුරා දරුවන් දස දහසක්ගේ අධ්‍යාපන කටයුතු අඩාල වී ඇත. එම දරුවන් සඳහා එක් දරුවකුට රු. 5000 ක් වටිනා පාසල් උපකරණ සහ පොත්පත් ලබාදීමට උමංදාව තීරණය කර ඇත.\n\nඔබට දරුවන් 5, 10 හෝ 20 දෙනෙකු භාරගෙන ඔවුන්ගේ අනාගත අධ්‍යාපන කටයුතු සඳහා සහය දීමට හැකියාවක් ඇත්නම්—අප හා එක්වන්න. කඩාවැටුණු දේශය නැවත ගොඩනඟමු!\n\n📞 WhatsApp (තැන්පතුව තහවුරු කිරීම සඳහා): +94 773 686 686\n📞 විමසීම්: +94 775 440 888\n\n🏦 බැංකු තැන්පතු විස්තර:\nUmandawa Saviya Foundation\nAccount No: 344200150024678\nPeople’s Bank — Melsiripura Branch\nBank Code: 7135\nSWIFT: PSBKLKLX",
